...
export function ChatSidebar({
  ...
  const overviewPreviews = useMemo<Record<string, SessionInfo[]>>(
    () =>
      // Default loads PROJECT_PREVIEW_LOADED per project (shown three, the rest
      // scrollable inside the preview window); the "show all" toggle lifts the
      // cap so every session in the project rides along.
      overlayLivePreviews(
        projectOverview ?? [],
        agentSessions,
        projects,
        showAllSessions ? Infinity : PROJECT_PREVIEW_LOADED,
        {
